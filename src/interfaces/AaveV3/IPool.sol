...
import {IPoolAddressesProviderV3} from './IPoolAddressesProvider.sol';
import {DataTypesV3} from '../../contracts/libraries/DataTypesAaveV3.sol';
...
interface IPoolV3 {
   ...
   **/
  function ADDRESSES_PROVIDER() external view returns (IPoolAddressesProviderV3);
